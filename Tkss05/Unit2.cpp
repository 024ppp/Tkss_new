...
//  Unit2.cpp
//    【出荷検査システム－製品規格マスター】
//    出荷検査項目フォーム（TForm2クラス）のメンバ関数の定義
//
//  作成者
//    田村　敦司
//
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::BtnF08F09Click(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Pnl_ListResize(TObject *Sender)
{
    int iBMarg;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_KIKAKU_SHITEI_HANIClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_KIKAKU_SHITEI_KIJYUNClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_KIKAKU_SHITEI_MOJIClick(TObject *Sender)
{
    Pnl_KIKAKU_HANI->Visible   = false;
    Pnl_KIKAKU_KIJYUN->Visible = false;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_KIKAKU_SYURUI_MINMAXClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_KIKAKU_SYURUI_MAXClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_KIKAKU_SYURUI_MINClick(TObject *Sender)
{
    Nmb_KIKAKU_HANI_MIN->Enabled	= true;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::PgCtr_ListChange(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_VALUE_NORMALClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_VALUE_KAKUDOClick(TObject *Sender)
{
    Nmb_VALUE_DOUBLE->Enabled     = true;
    Nmb_VALUE_DOUBLE->Font->Color = clBlack;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_VALUE_OKClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_VALUE_TEXTClick(TObject *Sender)
{
    Nmb_VALUE_DOUBLE->Enabled     = false;
    Nmb_VALUE_DOUBLE->Font->Color = clGray;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::SGr_ListDrawCell(TObject *Sender, int ACol,
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::SGr_ListClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::SGr_ListKeyPress(TObject *Sender, char &Key)
{
     switch(Key)
     {
         // 前項
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::SGr_ListSelectCell(TObject *Sender, int ACol,
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_List1_OrderClick(TObject *Sender)
{
    int				i, k, m;
	AnsiString		sBuf;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Rdo_List2_OrderClick(TObject *Sender)
{
    int				i, k, m;
	AnsiString		sBuf;
	TRadioButton	*rdo = (TRadioButton *)Sender;
...
//
//---------------------------------------------------------------------------
AnsiString __fastcall TForm2::GridLineCopy( TStringGrid* sg, int iCpyIndex)
{
	AnsiString sBuf;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::GridLinePaste( TStringGrid* sg, int iPstIndex, AnsiString sUpdFlg)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Nmb_KIKAKU_DOUBLEExit(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm2::Edt_ALLChange(TObject *Sender)
{

...
__published:	// IDE 管理のコンポーネント
	...
	void __fastcall Splitter4CanResize(TObject *Sender, int &NewSize, bool &Accept);
	void __fastcall SGr_vRIRE_SYUKATopLeftChanged(TObject *Sender);
	void __fastcall SGr_vSOKU_SYUKATopLeftChanged(TObject *Sender);
    void __fastcall SGr_tRIRE_SOZAIDrawCell(TObject *Sender, int ACol, int ARow, TRect &Rect, TGridDrawState State);
    ...
    void __fastcall SGr_tSOKU_SOZAIDrawCell(TObject *Sender, int ACol, int ARow, TRect &Rect, TGridDrawState State);
    void __fastcall SGr_tRIRE_SYUKADrawCell(TObject *Sender, int ACol, int ARow, TRect &Rect, TGridDrawState State);
    void __fastcall SGr_tSOKU_SYUKADrawCell(TObject *Sender, int ACol, int ARow, TRect &Rect, TGridDrawState State);
...
//追加コードです
	...
	void __fastcall KSM01_LOCKON(void);
	void __fastcall KSM01_LOCKOFF(void);
...
//その他変数
	...
	TStrings	*sRIREKI_HIN;		// 履歴自社品番 onishi
...
//2003.05.10 A.Tamura Add
	...
	AnsiString sNowHINBAN;
	AnsiString sNowLOTNO;
	bool	   bNowSEIKANDATA;
	AnsiString sNowSEIKAN_YMD;                                  //onishi 生管検索開始日付
	bool	   bNowRIRE;
	int 	   iNowRIRE_NUM;

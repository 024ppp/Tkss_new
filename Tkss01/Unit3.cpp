...
void __fastcall TForm3::BtnF11Click(TObject *Sender)
{
     ...
     strcpy( tmpKSD01_DATA.HINBAN1_SZ	,sBuf.c_str()				);	// 素材用自社品番1
     strcpy( tmpKSD01_DATA.HINBAN2_SZ	,sBuf.c_str()				);	// 素材用自社品番2
     strcpy( tmpKSD01_DATA.HINBAN3_SZ	,sBuf.c_str()				);	// 素材用自社品番3
     strcpy( tmpKSD01_DATA.HINBAN4_SZ	,sBuf.c_str()				);	// 素材用自社品番4
     strcpy( tmpKSD01_DATA.HINBAN5_SZ	,sBuf.c_str()				);	// 素材用自社品番5
     strcpy( tmpKSD01_DATA.HINBAN6_SZ	,sBuf.c_str()				);	// 素材用自社品番6

...
//  Unit6.cpp
//    【出荷検査システム－検査測定】
//    測定項目編集フォーム（TForm6クラス）のメンバ関数の定義
//
//  作成者
//    田村　敦司
//
...
//
//  概要
//    OnCreateイベント	：Form6を作成したときに発生します。
//
//  機能説明
//    初期画面の状態を設定します。
//
...
void __fastcall TForm6::FormActivate(TObject *Sender)
{
    ...
    // 品番
	Pnl_HINBAN->Caption = Form3->SGr_SOKUT->Cells[1][Form3->SGr_SOKUT->Row];

    // 測定項目（日本語）
    Edt_SKTKMK_JPN->Text = Form3->SGr_SOKUT->Cells[2][Form3->SGr_SOKUT->Row];

    // 項目名（英語）
    Edt_SKTKMK_ENG->Text = Form3->SGr_SOKUT->Cells[4][Form3->SGr_SOKUT->Row];

    // 測定項目サブ名称（日本語）
    Edt_SKTKMK_JPN_SUB->Text = Form3->SGr_SOKUT->Cells[3][Form3->SGr_SOKUT->Row];

    // 測定項目サブ名称（英語）
    Edt_SKTKMK_ENG_SUB->Text = Form3->SGr_SOKUT->Cells[16][Form3->SGr_SOKUT->Row];

    // 測定機器
    k = Form3->SGr_SOKUT->Cells[17][Form3->SGr_SOKUT->Row].ToIntDef(-1);
    if( k == -1 ){
    ...
    // 単位
    Cmb_TANI->Text = Form3->SGr_SOKUT->Cells[5][Form3->SGr_SOKUT->Row];

	// 測定項目としての扱い
    switch( Form3->SGr_SOKUT->Cells[10][Form3->SGr_SOKUT->Row].ToIntDef(-1) ){
	...
	// 特別項目としての扱い
    switch( Form3->SGr_SOKUT->Cells[11][Form3->SGr_SOKUT->Row].ToIntDef(-1) ){
	...
	// 規格（指定方法）
    switch( Form3->SGr_SOKUT->Cells[18][Form3->SGr_SOKUT->Row].ToIntDef(-1) ){
	...
	// 規格（種類）
    switch( Form3->SGr_SOKUT->Cells[19][Form3->SGr_SOKUT->Row].ToIntDef(-1) ){
	...
	// 規格（上限下限値の印刷）
    switch( Form3->SGr_SOKUT->Cells[28][Form3->SGr_SOKUT->Row].ToIntDef(-1) ){
	...
	// 規格（小数点以下桁数）
    Nmb_KIKAKU_DOUBLE->Text = IntToStr(Form3->SGr_SOKUT->Cells[20][Form3->SGr_SOKUT->Row].ToIntDef(0));

	// 規格値（範囲指定）
    Nmb_KIKAKU_HANI_MIN->FPos = Form3->SGr_SOKUT->Cells[20][Form3->SGr_SOKUT->Row].ToIntDef(0);
    Nmb_KIKAKU_HANI_MAX->FPos = Form3->SGr_SOKUT->Cells[20][Form3->SGr_SOKUT->Row].ToIntDef(0);
    Nmb_KIKAKU_HANI_MIN->Text = Form3->SGr_SOKUT->Cells[21][Form3->SGr_SOKUT->Row];
    if( Form3->SGr_SOKUT->Cells[18][Form3->SGr_SOKUT->Row].ToIntDef(-1) == 1 ){
	    Nmb_KIKAKU_HANI_MAX->Text = Form3->SGr_SOKUT->Cells[22][Form3->SGr_SOKUT->Row];
    }
    else {
	...
	// 規格値（基準値指定）
    Nmb_KIKAKU_KIJYUN_MID->FPos = Form3->SGr_SOKUT->Cells[20][Form3->SGr_SOKUT->Row].ToIntDef(0);
    Nmb_KIKAKU_KIJYUN_MAX->FPos = Form3->SGr_SOKUT->Cells[20][Form3->SGr_SOKUT->Row].ToIntDef(0);
    Nmb_KIKAKU_KIJYUN_MIN->FPos = Form3->SGr_SOKUT->Cells[20][Form3->SGr_SOKUT->Row].ToIntDef(0);
    Nmb_KIKAKU_KIJYUN_MID->Text = Form3->SGr_SOKUT->Cells[21][Form3->SGr_SOKUT->Row];
    if( Form3->SGr_SOKUT->Cells[18][Form3->SGr_SOKUT->Row].ToIntDef(-1) == 2 ){
    	Nmb_KIKAKU_KIJYUN_MAX->Text = Form3->SGr_SOKUT->Cells[22][Form3->SGr_SOKUT->Row];
    	Nmb_KIKAKU_KIJYUN_MIN->Text = Form3->SGr_SOKUT->Cells[23][Form3->SGr_SOKUT->Row];
    }
    else {
	...
	// 規格値（文字指定）
    Edt_KIKAKU_STRING->Text = Form3->SGr_SOKUT->Cells[24][Form3->SGr_SOKUT->Row];

	// 測定値（値表現）
    switch( Form3->SGr_SOKUT->Cells[8][Form3->SGr_SOKUT->Row].ToIntDef(-1) ){
	...
	// 測定値（小数点以下桁数）
    Nmb_VALUE_DOUBLE->Text = IntToStr(Form3->SGr_SOKUT->Cells[29][Form3->SGr_SOKUT->Row].ToIntDef(0));

	// 測定値（抜取ｎ数）
    Nmb_N->Text = IntToStr(Form3->SGr_SOKUT->Cells[7][Form3->SGr_SOKUT->Row].ToIntDef(2));

    // ラベルの色を設定します
    SetColor(Form3->SGr_SOKUT->Cells[15][Form3->SGr_SOKUT->Row].ToIntDef(2));
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::BtnF02Click(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::BtnF03Click(TObject *Sender)
{
	keybd_event(VK_TAB,0,0,0);
	keybd_event(VK_TAB,0,KEYEVENTF_KEYUP,0);
}
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::BtnF08Click(TObject *Sender)
{
    ...
    sBuf = Form3->SGr_SOKUT->Cells[13][Form3->SGr_SOKUT->Row];
	strcpy( Form3->tmpKSM02_DATA.UNQ_NO			,sBuf.c_str() );	// 明細NO
    sBuf = Form3->SGr_SOKUT->Cells[14][Form3->SGr_SOKUT->Row];
	strcpy( Form3->tmpKSM02_DATA.ORDER_NO		,sBuf.c_str() );	// 表示順
    sBuf = Form3->SGr_SOKUT->Cells[15][Form3->SGr_SOKUT->Row];
	...
	sBuf = Form3->SGr_SOKUT->Cells[12][Form3->SGr_SOKUT->Row];
    ...
    // 修正後の値を元の画面に設定します
    Form3->SGr_SOKUT_GridLinePaste( Form3->SGr_SOKUT->Row, "1", true );
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::BtnF12Click(TObject *Sender)
{
    Close();
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_KIKAKU_SHITEI_HANIClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_KIKAKU_SHITEI_KIJYUNClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_KIKAKU_SHITEI_MOJIClick(TObject *Sender)
{
    Pnl_KIKAKU_HANI->Visible   = false;
    Pnl_KIKAKU_KIJYUN->Visible = false;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_KIKAKU_SYURUI_MINMAXClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_KIKAKU_SYURUI_MAXClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_KIKAKU_SYURUI_MINClick(TObject *Sender)
{
    Nmb_KIKAKU_HANI_MIN->Enabled	= true;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_VALUE_NORMALClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_VALUE_KAKUDOClick(TObject *Sender)
{
    Nmb_VALUE_DOUBLE->Enabled     = true;
    Nmb_VALUE_DOUBLE->Font->Color = clBlack;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_VALUE_OKClick(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Rdo_VALUE_TEXTClick(TObject *Sender)
{
    Nmb_VALUE_DOUBLE->Enabled     = false;
    Nmb_VALUE_DOUBLE->Font->Color = clGray;
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Nmb_KIKAKU_DOUBLEExit(TObject *Sender)
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::SetColor( int iSKB_NO )
{
...
//
//---------------------------------------------------------------------------
void __fastcall TForm6::Edt_ALLChange(TObject *Sender)
{
